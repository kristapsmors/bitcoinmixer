...
<body>
    <div id="top">
        <div class="buffer">
            <a href="{{URL::to('/')}}" id="logo" class="button" data-slide="0" title="Bitcoin Mixer"></a>
            <ul class="navigation">
    ...
    <div class="slide lightslide" id="slide1" data-slide="1" data-stellar-background-ratio="0.1">
        <div class="buffer content">
            ...
            <form id="submitOrder" action="" method="post">
                ...
                <div id="error-area"> 
                    <div id="error-error" class="errmsg" style="display:none;"></div>
                </div>
            ...
            <script>
                $('#submitorder').click(function() {
                    ...
                    $.post('/index.php/ajax', $('#submitOrder').serialize(), function(data){
                        ...
                        if(data.error) {
                            $('#submitOrder').show();
                            $('#error-error').html(data.message);
                            $('#error-error').show();
                        } else {
                            var url = '{{URL::to('status')}}/' + data.order_key;
